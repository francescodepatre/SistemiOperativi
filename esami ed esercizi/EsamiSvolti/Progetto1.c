...
//PER COMPILARE ED ESEGUIRE I FILE "Progetto0.c" "Progetto1.c" e "Progetto2.c" e chiamare il comando (gcc -o Progetto0 Progetto0.c) per il primo file, (gcc -o Progetto1 Progetto1.c) per il secondo file e (gcc -o Progetto2 Progetto2.c) per il terzo file.                             Per eseguire i file: ./Progetto0 argv[1] argv[2] per il primo, ./Progetto1 argv[1] argv[2] per il secondo e ./Progetto2 argv[1] argv[2] per il terzo.
